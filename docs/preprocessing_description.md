...
- **Target format:** PNG (grayscale)
- **Conversion policy:** Lossless or high-quality conversion
- **Directory structure:** Preserved during conversion
- **Annotation references:** Updated to match converted filenames

This step ensured uniform image handling across all subsequent processing stages.
...
A **uniform bottom-region crop (approximately 6% of image height)** was applied to all
images.
